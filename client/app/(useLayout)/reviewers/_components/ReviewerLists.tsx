...
export default function Reviewers() {
    ...
    const { data, isPending } = useGetAllPost({
        page,
        filter: val,
        langFilter: langVal,
    });
    ...
    useEffect(() => {
        queryClient.invalidateQueries({ queryKey: ["posts", { page, filter: val, langFilter: langVal }] });
    }, [page, val, langVal, queryClient]);
    ...
    if (isPending && !data) return <CSpinner />;
    return (
