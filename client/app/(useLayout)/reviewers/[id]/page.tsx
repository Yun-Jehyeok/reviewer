...
export default function ReviewerDetail() {
    ...
    const onClick = (e: React.FormEvent<HTMLFormElement> | React.MouseEvent<HTMLButtonElement>) => {
        if (user._id === "") {
            ...
            <div className="w-2/3">
                ...
                <div className="w-full h-fit">
                    <div className="text-darkblue text-2xl font-bold font-josefin mb-3">
                        리뷰
                        <span className="text-base text-gray-500 font-medium">&nbsp;총 {post.reviews.length}개</span>
                    </div>
            ...
            <div className="flex-1">
                ...
                <div className="w-full h-fit p-12 bg-white rounded-lg shadow-2xl">
                    ...
                    <div className="flex flex-col gap-6">
                        {/* 닉네임 */}
                        <div className="text-xl font-bold text-center">{post.creator.nickname}</div>
                        {/* 소개 */}
                        <div>
                            <div className="text-base font-bold mb-2">소개</div>
                            <div className="text-sm text-gray-600">
                                {post.creator.introduce === "" ? (
